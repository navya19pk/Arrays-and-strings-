...
//Output:
//Enter a string for str1 (empty string): navya
//str1: "navya"
//Enter a string for str2: vaani
//str2: vaani
//Enter a string for str3: kamaksshee
//str3: kamaksshee
//Enter a number of repetitions for '*' in str4: 6
//str4: ******
//str5 (copy of str2): vaani
//Enter a string for cstr1 (C-style): Pawan
//cstr1: Pawan
//Enter a string for cstr2 (character by character): Neena
//cstr2: Neena
